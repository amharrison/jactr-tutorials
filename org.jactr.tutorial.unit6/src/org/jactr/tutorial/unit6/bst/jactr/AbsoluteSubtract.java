...
public class AbsoluteSubtract extends AbstractSlotCondition {

	public AbsoluteSubtract() {
	}

	public AbsoluteSubtract(VariableBindings bindings, Collection<? extends ISlot> slots) {
		super();
	...
	public int bind(IModel model, VariableBindings bindings, boolean iterativeCall) throws CannotMatchException {
	    ...
	    if(unresolved==0)
	    {
	    	...
	    	double delta = Math.abs(arg1 - arg2);
	...
	public ICondition clone(IModel model, VariableBindings bindings) throws CannotMatchException {
		...
		return new AbsoluteSubtract(bindings, getSlots());
	}
